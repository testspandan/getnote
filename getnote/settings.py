"""
Django settings for getnote project.
...
SECRET_KEY = 'px@pv1arnz7v)z#%#dux$6zkrws_h4e6w%6*p42+(_43-henqz'
...
WSGI_APPLICATION = 'getnote.wsgi.application'
